  ...
  const handleAddSubgroup = async () => {
    ...
    try {
      ...
      const mockSubgroup = {
        ...
        is_premium: selectedCategory !== 'public',
        is_locked: selectedCategory !== 'public',
        is_public: selectedCategory === 'public',
        is_realtime: selectedCategory !== 'public',
        is_published: true,
        is_subgroup: true,
    ...
    try {
      const mockSubgroups = SUBGROUP_CATEGORIES.map(category => {
        ...
        return {
          ...
          cover_url: `https://placehold.co/600x200?text=${username}`,
          type: category.id,
          is_premium: category.id !== 'public',
          is_locked: category.id !== 'public',
          is_public: category.id === 'public',
          is_realtime: category.id !== 'public',
          is_published: true,
          is_subgroup: true,
          owner_username: ownerUsername,
          is_secondary_stream: false,
